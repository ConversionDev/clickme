...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "plan_type",
            sa.Enum("free", "professional", "enterprise", name="plan_type"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_persona_templates_cluster_id"), "persona_templates", ["cluster_id"], unique=False
    )
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.Column(
            "input_type",
            sa.Enum("image", "text", "video", "url", name="ad_input_type"),
            nullable=False,
        ),
        ...
        sa.Column(
            "analysis_status",
            sa.Enum("pending", "analyzing", "completed", "failed", name="ad_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_generated_ads_project_id"), "generated_ads", ["project_id"], unique=False
    )
    op.create_table(
        "project_members",
        sa.Column("project_id", sa.UUID(), nullable=False),
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column(
            "role", sa.Enum("owner", "editor", "viewer", name="project_member_role"), nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "simulation_type",
            sa.Enum("ad_reaction", "survey", name="simulation_type"),
            nullable=False,
        ),
        sa.Column(
            "objective",
            sa.Enum("awareness", "conversion", name="campaign_objective"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("pending", "running", "completed", "failed", name="simulation_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_debate_results_simulation_id"), "debate_results", ["simulation_id"], unique=False
    )
    op.create_table(
        "persona_responses",
        sa.Column("simulation_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_persona_responses_segment"), "persona_responses", ["segment"], unique=False
    )
    op.create_index(
        op.f("ix_persona_responses_simulation_id"),
        "persona_responses",
        ["simulation_id"],
        unique=False,
    )
