...
class Simulation(Base, UUIDMixin, CreatedAtMixin):
    ...
    simulation_type: Mapped[SimulationType] = mapped_column(
        SAEnum(SimulationType, name="simulation_type"), nullable=False, default=SimulationType.ad_reaction
    )
    objective: Mapped[CampaignObjective] = mapped_column(
        SAEnum(CampaignObjective, name="campaign_objective"), nullable=False, default=CampaignObjective.conversion
    )
    status: Mapped[SimulationStatus] = mapped_column(
        SAEnum(SimulationStatus, name="simulation_status"), nullable=False, default=SimulationStatus.pending, index=True
    )
