...
async def seed() -> None:
    async with SessionLocal() as db:
        if (
            await db.execute(select(User).where(User.email == "admin@clickme.io"))
        ).scalar_one_or_none():
            print("seed: 이미 존재 - 스킵")
            return
        ...
        projects = [
            Project(
                ...
                created_by=U(2),
                name="여름 신제품 론칭 캠페인",
                description="2026년 여름 시즌 신제품 출시를 위한 광고 효과 사전 분석",
            ...
            Project(
                ...
                created_by=U(3),
                name="앱 다운로드 전환율 캠페인",
                description="모바일 앱 신규 설치 유도를 위한 소셜미디어 광고 최적화",
                status=ProjectStatus.active,
            ),
            Project(
                id=PID("10000000", 3),
                ...
                created_by=U(5),
                name="브랜드 인지도 제고 캠페인",
                description="신규 브랜드 런칭 인지도 광고",
                status=ProjectStatus.active,
            ),
        ]
        members = [
            ProjectMember(
                project_id=PID("10000000", 1), user_id=U(2), role=ProjectMemberRole.owner
            ),
            ProjectMember(
                project_id=PID("10000000", 1), user_id=U(3), role=ProjectMemberRole.editor
            ),
            ProjectMember(
                project_id=PID("10000000", 1), user_id=U(4), role=ProjectMemberRole.viewer
            ),
            ProjectMember(
                project_id=PID("10000000", 2), user_id=U(3), role=ProjectMemberRole.owner
            ),
            ProjectMember(
                project_id=PID("10000000", 2), user_id=U(4), role=ProjectMemberRole.editor
            ),
            ProjectMember(
                project_id=PID("10000000", 3), user_id=U(5), role=ProjectMemberRole.owner
            ),
        ]
        ...
        ads = [
            Ad(
                id=PID("20000000", 1),
                project_id=PID("10000000", 1),
                created_by=U(2),
                name="여름 신제품 메인 카피",
                input_type=AdInputType.text,
                text_content={
                    "headline": "올 여름, 당신의 일상을 바꿀 단 하나의 선택",
                    "body": "새로운 라이프스타일을 위한 스마트한 제품. 지금 바로 경험해보세요.",
                    "cta": "무료 체험 시작하기",
                },
            ...
            Ad(
                ...
                input_type=AdInputType.text,
                text_content={
                    "headline": "더위야 물렀거라! 시원한 여름 준비 완료",
                    "body": "프리미엄 기능을 합리적인 가격에. 한정 수량 특별 할인 진행 중.",
                    "cta": "지금 구매하기",
                },
            ...
            Ad(
                id=PID("20000000", 3),
                project_id=PID("10000000", 2),
                created_by=U(3),
                name="앱 다운로드 유도 배너",
                input_type=AdInputType.text,
                text_content={
                    "headline": "30초 만에 설치하고 첫 달 무료로 쓰세요",
                    "body": "이미 50만 명이 선택한 앱. 지금 다운로드하면 프리미엄 1개월 무료 제공.",
                    "cta": "앱 다운로드",
                },
                analysis_status=AdStatus.completed,
                analysis_result={
        ...
        pt = [
            (
                ...
                "cluster_young_female_worker",
                {
                    ...
                    "income_level": "중",
                    "location": "서울",
                    "lifestyle": ["SNS 활동적", "트렌드 민감", "온라인 쇼핑 선호"],
                    "media_channels": ["인스타그램", "유튜브", "틱톡"],
                    "pain_points": ["바쁜 일상", "가성비"],
                    "values": ["자기계발", "워라밸"],
                },
            ),
            (
                ...
                "cluster_mid_male_worker",
                {
                    ...
                    "income_level": "중상",
                    "location": "경기도",
                    "lifestyle": ["실용적 소비", "정보 수집 후 구매"],
                    "media_channels": ["유튜브", "네이버", "카카오"],
                    "pain_points": ["시간 부족", "신뢰성 중요"],
                    "values": ["안정", "효율"],
                },
            ),
            (
                ...
                "cluster_40s_female_homemaker",
                {
                    ...
                    "income_level": "중",
                    "location": "서울/경기",
                    "lifestyle": ["가족 중심", "커뮤니티 활동"],
                    "media_channels": ["카카오톡", "네이버 카페", "유튜브"],
                    "pain_points": ["가격 민감", "품질 중시"],
                    "values": ["가족", "건강", "신뢰"],
                },
            ),
            (
                ...
                "cluster_young_male_student",
                {
                    ...
                    "income_level": "하",
                    "location": "서울",
                    "lifestyle": ["게임", "배달음식", "구독서비스"],
                    "media_channels": ["유튜브", "트위치", "인스타그램"],
                    "pain_points": ["예산 한정", "가성비 극단적 중시"],
                    "values": ["재미", "커뮤니티", "경험"],
                },
            ),
            (
                ...
                "cluster_50s_male_selfemployed",
                {
                    ...
                    "income_level": "중상",
                    "location": "지방 대도시",
                    "lifestyle": ["오프라인 구매 선호", "입소문 중요"],
                    "media_channels": ["네이버", "카카오", "TV"],
                    "pain_points": ["디지털 복잡성", "사후지원"],
                    "values": ["신뢰", "실용성", "관계"],
                },
            ),
            (
                ...
                "cluster_30s_female_freelancer",
                {
                    ...
                    "income_level": "중",
                    "location": "서울",
                    "lifestyle": ["유연한 시간", "카페 작업", "온라인 커뮤니티"],
                    "media_channels": ["인스타그램", "유튜브", "링크드인"],
                    "pain_points": ["불안정한 수입", "자기관리"],
                    "values": ["자유", "창의성", "성장"],
                },
            ),
        ]
        db.add_all(
            [
                PersonaTemplate(
                    id=PID("30000000", i + 1), name=n, cluster_id=c, attributes=a, is_public=True
                )
                for i, (n, c, a) in enumerate(pt)
            ]
        )
        ...
        sim = Simulation(
            id=PID("40000000", 1),
            project_id=PID("10000000", 1),
            ad_id=PID("20000000", 1),
            created_by=U(2),
            simulation_type=SimulationType.ad_reaction,
            objective=CampaignObjective.conversion,
            status=SimulationStatus.completed,
            persona_count=20,
            persona_config={
                "ageRange": [20, 45],
                "genderRatio": {"female": 0.55, "male": 0.45},
                "regions": ["서울", "경기", "부산"],
                "includeClusters": [
                    "cluster_young_female_worker",
                    "cluster_mid_male_worker",
            ...
            results_summary={
                ...
                "kpi": {
                    "attentionScore": 0.81,
                    "sentimentScore": 0.62,
                    "clickIntentRate": 0.60,
                    "conversionIntentRate": 0.45,
            ...
            completed_at=now - timedelta(days=2) + timedelta(minutes=3),
        )
        db.add(sim)
        await db.flush()
        ...
        db.add_all(
            [
                PersonaResponse(
                    simulation_id=PID("40000000", 1),
                    persona_id=pid,
                    segment=seg,
                    persona_attributes=attr,
                    signals=sig,
                    reasoning=rsn,
                    confidence=conf,
            ...
            Report(
                ...
                report_data={
                    ...
                    "actionItems": {
                        "immediate": [
                            "헤드라인에 핵심 기능 1가지 명시",
                            "30대 남성 타겟 별도 소재 제작 검토",
                        ],
                        "copySuggestions": ["올 여름, [핵심기능]으로 일상을 바꿔보세요"],
                        "ctaSuggestions": ["7일 무료 체험 시작하기"],
        ...
        db.add_all(
            [
                ChatMessage(
                    session_id=PID("50000000", 1),
                    role=ChatRole.user,
                    content="방금 완료된 시뮬레이션 결과 요약해줘.",
                    meta={"simulationId": str(PID("40000000", 1))},
                ),
                ChatMessage(
                    session_id=PID("50000000", 1),
                    role=ChatRole.assistant,
                    content="여름 신제품 메인 카피 시뮬레이션 결과를 요약해드릴게요.\n\n**종합 점수: 74/100** — 긍정적 반응 우세\n\n주요 KPI: 주목도 81% · 클릭 의향 60% · 전환 의향 45%",
                    meta={"simulationId": str(PID("40000000", 1))},
                ),
                ChatMessage(
                    session_id=PID("50000000", 1),
                    role=ChatRole.user,
                    content="30대 남성 세그먼트를 위한 카피 개선안 3가지만 제안해줘.",
                    meta=None,
                ),
                ChatMessage(
                    session_id=PID("50000000", 1),
                    role=ChatRole.assistant,
                    content="30대 남성 세그먼트 맞춤 카피 개선안입니다.\n\n1. 기능 중심형\n2. 사회적 증거형\n3. 문제 해결형",
                    meta=None,
                ),
            ]
        )
